      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-txt-secondary text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              1.1. Исполнитель предоставляет Заказчику информационные материалы (PDF-документы, доступ к Telegram-каналу, консультации) по теме нейро-оптимизации и wellness-практик.
              <br /><br />
              1.2. Услуги НЕ являются образовательными в соответствии с ФЗ №273 &laquo;Об образовании в Российской Федерации&raquo;.
              <br /><br />
              1.3. Исполнитель не имеет лицензии на образовательную деятельность и не ведёт образовательную деятельность.
            </p>
          </section>
