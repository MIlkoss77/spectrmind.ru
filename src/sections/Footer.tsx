      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-xs text-txt-muted leading-relaxed mb-4 max-w-3xl">
            ...
            ВАЖНАЯ ИНФОРМАЦИЯ: SpectrMind — информационный ресурс, предоставляющий материалы по нейро-оптимизации, биохакингу и wellness-практикам. Мы НЕ являемся образовательной организацией и НЕ оказываем образовательных услуг. Все материалы предоставляются исключительно в информационных целях и НЕ являются медицинской консультацией, психологической терапией, образовательной программой или финансовой рекомендацией. Перед применением любых практик проконсультируйтесь с врачом, психологом или другим квалифицированным специалистом. Ответственность за применение информации несёт пользователь.
          </p>
